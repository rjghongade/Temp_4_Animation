...
import { FaRupeeSign, FaBuilding, FaRulerCombined, FaChevronRight, FaInfoCircle } from 'react-icons/fa';
...
const PropertyPrices = () => {
  ...
  return (
<section id="BanksSection" className="relative w-full py-16 text-white overflow-hidden bg-[#f8f9fa]">
  ...
  <div className="relative max-w-7xl mx-auto px-6 z-10">
    <div className="mb-16 text-center">
      <span className="text-sm font-medium text-[#cf6615] uppercase tracking-wider animate-fade-in">Premium Selection</span>
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-[#36322e] to-[#09305d]/80 backdrop-blur-sm p-6 rounded-xl shadow-2xl border border-[#7daa71]/20 hover:border-[#cf6615]/30 transition-all duration-500 h-full flex flex-col">
            <div className="relative z-10">
              ...
              <div className="mt-6 text-center">
                <a href="#contact" className="inline-block px-6 py-3 text-base font-medium text-white bg-[#cf6615] rounded-lg hover:bg-[#7daa71] transition duration-300">
                  Request More Detail
                </a>
              </div>
            </div>
